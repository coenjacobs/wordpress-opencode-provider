 ...
 * available through OpenCode Zen.
 */
class OpenAiCompatibleTextGenerationModel extends AbstractApiBasedModel implements TextGenerationModelInterface
{
    /**
    ...
    public function generateTextResult(array $prompt): GenerativeAiResult
    {
        ...
        $request = new Request(
            HttpMethodEnum::POST(),
            ZenProvider::url('chat/completions'),
